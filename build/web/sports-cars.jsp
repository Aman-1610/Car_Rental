...
<body>
    ...
    <main class="container">
        <h1 class="page-title">Premium Sports Cars</h1>
        <div class="car-grid">
        ...
        <%
            ...
            if (carList != null) {
                for (Car car : carList) {
                    if ("Sports".equalsIgnoreCase(car.getCategory())) {
        %>
            <div class="car-card">
                <div class="car-image">
                ...
                <div class="car-info">
                    ...
                    <a href="book?carId=<%= car.getId() %>" class="btn">Book Now</a>
                </div>
            </div>
        <%
                    }
        ...
        %>
            <p>No sports cars available right now.</p>
        <%
            }
        %>
